...
if ($name!=null && $lastName!=null && $email!=null && $phone!=null && $city!=null && $message!=null) {
    $msg="<table><thead><th colspan='2'>Un nuevo mensaje ha sido enviado desde mi Sitio Web Dial:</th></thead>
	<tbody>
	...
	<tr><td><strong>Mensaje: </strong></td><td>".$city."</td></tr>
	</tbody>
	</table>
	";
    $title = "Nuevo mensaje de contacto en Dialstudios";
    $to = 'dialstudios@gmail.com';
    $headers  = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
    $headers .= 'To: '.$to.'' . "\r\n";
    $headers .= 'From: Servicio Al Cliente <info@dialstudios.com.co>' . "\r\n";
